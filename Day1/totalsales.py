...
data = {
    'OrderDate': [
        '1-6-18', '1-23-18', '2-9-18', '2-26-18', '3-15-18',
    ...
    'Unit_price': [
        1198.00, 500.00, 1198.00, 225.00, 1198.00,
        500.00, 1198.00, 1198.00, 1198.00, 500.00,
        1198.00, 500.00, 500.00, 1198.00, 125.00,
        58.50, 500.00, 225.00
    ],
    'Sale_amt': [
...
pivot_table = df.pivot_table(values='Sale_amt', index=['Region', 'Manager', 'SalesMan'], aggfunc='sum')

print("Pivot table showing total sale amount region-wise, manager-wise, and salesman-wise:")
print(pivot_table)
